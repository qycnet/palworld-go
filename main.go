...
import (
	...
	"github.com/qycnet/palworld-go/bot"
	"github.com/qycnet/palworld-go/config"
	"github.com/qycnet/palworld-go/status"
	"github.com/qycnet/palworld-go/sys"
	"github.com/qycnet/palworld-go/tool"
	"github.com/qycnet/palworld-go/webui"
)
...
func main() {
	...
	// 打印配置以确认
	fmt.Printf("当前配置: %#v\n", jsonconfig)
	fmt.Printf("作者 早苗狐 答疑群:000000\n")
	//给程序整个标题
	sys.SetTitle(jsonconfig.Title + " 作者 早苗狐 答疑群:000000")
